...
var RobotUtilsJs = (function(self) {
     ...
     * Sample usage:
     *
     *   RobotUtilsJs.onServices(function(ALLeds, ALTextToSpeech) {
     *     ALLeds.randomEyes(2.0);
     *     ALTextToSpeech.say("I can speak");
     *   });
     *
     * This is actually syntactic sugar over RobotUtilsJs.connect() and
    ...
    /* RobotUtilsJs.setWaitableServices(serviceA, serviceB, ...)
     *
     * Flag some services as "to be awaited" - this means that if they
     * are missing when RobotUtilsJs.onServices(...) is called, if a
    ...
    /* RobotUtilsJs.connect(connectedCallback, failureCallback)
     *
     ...
     * should probably use the more specific RobotUtilsJs.onServices or
     * RobotUtilsJs.subscribeToALMemoryEvent.
     *
